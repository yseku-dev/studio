    ...
    <div className="flex flex-col gap-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl flex items-center gap-2">
           ...
           <CardDescription>Accede rápidamente a las herramientas clave de CodeAlchemist.</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="bg-accent/5 border-accent/30">
        ...
        <CardContent className="space-y-3 text-accent-foreground/90">
          ...
          <p><strong>3. Explora el AutoUpdate:</strong> En la sección de <Link href="/autoupdate" className="font-semibold hover:underline">AutoUpdate</Link>, permite que CodeAlchemist analice su propio código fuente. Puedes guiar el análisis con tus preferencias.</p>
