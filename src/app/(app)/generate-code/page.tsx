...
export default function GenerateCodePage() {
  ...
  const addServerLogsToDebug = useCallback((serverLogs: string[] | undefined, sourcePrefix: string = 'SERVER_GEN_CODE') => {
  ...
  const proceedWithGeneration = async () => {
    ...
    if (watchedConfigSource.startsWith('workgroup:')) {
        ...
        addServerLogsToDebug(result.workgroupLogs, 'SERVER_WG_GEN_CODE');
    } else {
